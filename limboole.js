...
var createLimbooleModule = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(createLimbooleModule) {
  createLimbooleModule = createLimbooleModule || {};
...
var Module = typeof createLimbooleModule !== 'undefined' ? createLimbooleModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_limboole')) {
        Object.defineProperty(Module['ready'], '_limboole', { configurable: true, get: function() { abort('You are getting _limboole on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_limboole', { configurable: true, set: function() { abort('You are setting _limboole on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var STACK_BASE = 5347056,
    STACKTOP = STACK_BASE,
    STACK_MAX = 104176,
    DYNAMIC_BASE = 5347056;
...
var wasmBinaryFile = 'limboole.wasm';
...
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__indirect_function_table": wasmTable, "__sys_fcntl64": ___sys_fcntl64, "__sys_getpid": ___sys_getpid, "__sys_getrusage": ___sys_getrusage, "__sys_ioctl": ___sys_ioctl, "__sys_open": ___sys_open, "__sys_wait4": ___sys_wait4, "abort": _abort, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "nanosleep": _nanosleep, "setTempRet0": _setTempRet0, "usleep": _usleep };
var asm = createWasm();
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _limboole = Module["_limboole"] = createExportWrapper("limboole");
...
// {{MODULE_ADDITIONS}}
  ...
  return createLimbooleModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = createLimbooleModule;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return createLimbooleModule; });
    else if (typeof exports === 'object')
      exports["createLimbooleModule"] = createLimbooleModule;
